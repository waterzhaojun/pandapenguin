...
res.blockunit = 0.005; % every block is 20mm, When the two LED go through it, the number jump 4 times.
res.acceleration_threshold = 0.01; %Not necessary if not use Drew lab method 0.000001
